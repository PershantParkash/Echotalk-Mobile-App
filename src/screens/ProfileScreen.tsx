      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="bg-[#5B2EC4] pb-8 pt-4 px-5 rounded-b-[40px] shadow-lg">
          ...
          <View className="items-center">
            ...
            <Text className="text-sm text-purple-100">{userDetails.email}</Text>
          </View>
        </View>
        ...
        <View className="px-5 mt-6">
          ...
          <View className="mb-6">{generalMenuItems.map(renderMenuItem)}</View>

          {/* Others Section */}
          <Text className="text-base font-semibold text-gray-900 mb-3">
            Others
          </Text>
          <View className="mb-6">{otherMenuItems.map(renderMenuItem)}</View>
        </View>
